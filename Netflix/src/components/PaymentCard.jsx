...
const data=useSelector((e)=>{
  ...
  return (
    <div style={{width:"100%", display:"flex",marginTop:"5.8rem"}}>
        <div style={{width:"50%"}}>
            <img src="https://cdn.dribbble.com/users/1299339/screenshots/14693431/media/0d14cfd0199c68d53fff50e42cca6c4b.gif" style={{width:"100%"}}/>
        </div>
